  ...
  return (
    <section className='w-full hero-bg'>
        ...
        className=' px-3px sm:px-6  lg:px-10 w-full'>
              <h1 className='pop text-blue-50 text-4xl sm:text-5xl md:text-6xl lg:text-7xl mt-2 font-bold leading-14 lg:leading-20'>Power Your Future With Hakuna Solar System</h1> 
             ...
             <Link to="/product"> <button className='btn'>View all Product</button></Link>
        </motion.div>
        <div className='overflow-x-hidden w-full px-3 mt-10 md:mt-20'>
              ...
              <div className='scrollAnimate flex justify-between items-center gap-6 '>
                    <div className='w-[300px] p-6 flex items-center rounded-lg transition border-white gap-3  bg-[var(--b-c)]'>
                   ...
                   className='w-[350px] p-6 flex items-center rounded-lg   gap-3  bg-amber-200'>
                      ...
                      className='w-[300px] p-6 flex items-center  rounded-lg shadow-xl hover:shadow-1xl transition border-white gap-3 bg-[var(--b-c)]   '>
